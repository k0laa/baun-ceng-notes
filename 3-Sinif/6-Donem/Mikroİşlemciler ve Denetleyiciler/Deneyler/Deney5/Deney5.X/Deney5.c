...
void Deney5_step(void)
{
  ...
  rtb_DigitalInput = PORTBbits.RB0;    /* Read pin B0 */

  /* S-Function (sdspcount2): '<Root>/Counter' */
  if (MWDSP_EPH_R_B(rtb_DigitalInput, &Deney5_DW.Counter_ClkEphState) != 0UL) {
    if (Deney5_DW.Counter_Count < 4) {
      Deney5_DW.Counter_Count++;
    } else {
      Deney5_DW.Counter_Count = 0U;
    }
  }
   ...
   *  S-Function (sdspcount2): '<Root>/Counter'
   */
  rtb_DigitalInput = (Deney5_DW.Counter_Count >= 3);

  /* S-Function (MCHP_Digital_Output_Write): '<S1>/Digital Output Write' */
  LATBbits.LATB7 = rtb_DigitalInput;
}

/* Model initialize function */
void Deney5_initialize(void)
{
  ...
  Deney5_DW.Counter_ClkEphState = 5UL;
}

/* Model terminate function */
void Deney5_terminate(void)
{
