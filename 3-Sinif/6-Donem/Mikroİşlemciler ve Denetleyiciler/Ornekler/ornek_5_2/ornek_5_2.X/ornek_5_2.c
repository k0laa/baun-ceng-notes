 ...
 * File: ornek_5_2.c
 *
 * Code generated for Simulink model 'ornek_5_2'.
 *
 * Model version                  : 1.1
 * Simulink Coder version         : 23.2 (R2023b) 01-Aug-2023
 * C/C++ source code generated on : Thu Jul 16 18:27:10 2026
 */
...
void ornek_5_2_step(void)
{
  ...
  rtb_DigitalInput = PORTCbits.RC9;    /* Read pin C9 */

  /* CombinatorialLogic: '<S2>/Logic' incorporates:
   *  Memory: '<S2>/Memory'
   */
  rowIdx = (int16_T)(((((uint16_T)rtb_DigitalInput << 1) + false) << 1) +
                     ornek_5_2_DW.bitsForTID0.Memory_PreviousInput);
  rtb_Logic[0U] = ornek_5_2_ConstP.Logic_table[(uint16_T)rowIdx];
  rtb_Logic[1U] = ornek_5_2_ConstP.Logic_table[(uint16_T)rowIdx + 8U];

  /* S-Function (MCHP_Digital_Output_Write): '<S1>/Digital Output Write' */
  LATAbits.LATA9 = rtb_Logic[0];
  LATAbits.LATA10 = rtb_Logic[1];

  /* Update for Memory: '<S2>/Memory' */
  ornek_5_2_DW.bitsForTID0.Memory_PreviousInput = rtb_Logic[0];
}

/* Model initialize function */
void ornek_5_2_initialize(void)
{
