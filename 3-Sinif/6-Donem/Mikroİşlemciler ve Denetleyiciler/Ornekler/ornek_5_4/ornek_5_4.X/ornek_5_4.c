...
void ornek_5_4_step(void)
{
   ...
   *  S-Function (MCHP_Digital_Input): '<Root>/Digital Input'
   */
  if (ornek_5_4_DW.bitsForTID0.Memory2_PreviousInput) {
    rtb_Memory_e = false;
  } else {
    rtb_Memory_e = ((!ornek_5_4_DW.bitsForTID0.Memory1_PreviousInput) && PORTCbits.RC0);
  }
   ...
   *  Memory: '<S2>/Memory'
   */
  rowIdx = (int16_T)(((((uint16_T)rtb_Memory_e << 1) + rtb_DigitalInput_o4) << 1) +
                     ornek_5_4_DW.bitsForTID0.Memory_PreviousInput);
  rtb_Logic[0U] = ornek_5_4_ConstP.pooled2[(uint16_T)rowIdx];
  rtb_Logic[1U] = ornek_5_4_ConstP.pooled2[(uint16_T)rowIdx + 8U];
  ...
  if (ornek_5_4_DW.bitsForTID0.Memory2_PreviousInput) {
    ...
    rtb_Memory_e = ((!ornek_5_4_DW.bitsForTID0.Memory_PreviousInput_o) && PORTCbits.RC1);
  }
   ...
   */
  rowIdx = (int16_T)(((((uint16_T)rtb_Memory_e << 1) + rtb_DigitalInput_o4) << 1) +
                     ornek_5_4_DW.bitsForTID0.Memory_PreviousInput_ob);
  rtb_Logic_p[0U] = ornek_5_4_ConstP.pooled2[(uint16_T)rowIdx];
  rtb_Logic_p[1U] = ornek_5_4_ConstP.pooled2[(uint16_T)rowIdx + 8U];
   ...
   *  S-Function (MCHP_Digital_Input): '<Root>/Digital Input'
   */
  if (ornek_5_4_DW.bitsForTID0.Memory1_PreviousInput) {
    rtb_Memory_e = false;
  } else {
    rtb_Memory_e = ((!ornek_5_4_DW.bitsForTID0.Memory_PreviousInput_o) && PORTCbits.RC2);
  }
   ...
   */
  rowIdx = (int16_T)(((((uint16_T)rtb_Memory_e << 1) + rtb_DigitalInput_o4) << 1) +
                     ornek_5_4_DW.bitsForTID0.Memory_PreviousInput_l);
  rtb_Logic_d[0U] = ornek_5_4_ConstP.pooled2[(uint16_T)rowIdx];
  rtb_Logic_d[1U] = ornek_5_4_ConstP.pooled2[(uint16_T)rowIdx + 8U];

  /* S-Function (MCHP_Digital_Output_Write): '<S1>/Digital Output Write' */
  LATBbits.LATB0 = rtb_Logic[0];
  LATBbits.LATB1 = rtb_Logic_p[0];
  LATBbits.LATB2 = rtb_Logic_d[0];

  /* Update for Memory: '<Root>/Memory2' */
  ornek_5_4_DW.bitsForTID0.Memory2_PreviousInput = rtb_Logic_d[0];

  /* Update for Memory: '<Root>/Memory1' */
  ornek_5_4_DW.bitsForTID0.Memory1_PreviousInput = rtb_Logic_p[0];

  /* Update for Memory: '<S2>/Memory' */
  ornek_5_4_DW.bitsForTID0.Memory_PreviousInput = rtb_Logic[0];

  /* Update for Memory: '<Root>/Memory' */
  ornek_5_4_DW.bitsForTID0.Memory_PreviousInput_o = rtb_Logic[0];

  /* Update for Memory: '<S3>/Memory' */
  ornek_5_4_DW.bitsForTID0.Memory_PreviousInput_ob = rtb_Logic_p[0];

  /* Update for Memory: '<S4>/Memory' */
  ornek_5_4_DW.bitsForTID0.Memory_PreviousInput_l = rtb_Logic_d[0];
}

/* Model initialize function */
void ornek_5_4_initialize(void)
{
