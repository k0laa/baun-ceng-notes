...
void ornek_13_1_step(void)
{
   ...
   */
  rtb_DigitalInput_o1 = ((rtb_DigitalInput_o1 && rtb_DigitalInput_o2 && (!rtb_DigitalInput_o3) &&
    (!rtb_DigitalInput_o4)) || ((!rtb_DigitalInput_o1) && (!rtb_DigitalInput_o2) && rtb_DigitalInput_o3 &&
    rtb_DigitalInput_o4));

  /* S-Function (MCHP_Digital_Output_Write): '<S1>/Digital Output Write' */
  LATBbits.LATB0 = rtb_DigitalInput_o1;
}

/* Model initialize function */
void ornek_13_1_initialize(void)
{
...
void ornek_13_1_terminate(void)
{
