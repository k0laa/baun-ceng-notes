...
int main()
{
  ...
  TRISB = 0xFFF3;                      /* Port input (1) / output (0) */
  TRISC = 0xFC00;                      /* Port input (1) / output (0) */
  ...
  /* Enable Time-step */
  TMR1 = 0x0F9E;                       /* Initialize Timer Value */
