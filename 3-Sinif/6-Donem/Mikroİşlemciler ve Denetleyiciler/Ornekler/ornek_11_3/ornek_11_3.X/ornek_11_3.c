...
#include "ornek_11_3.h"
#include "ornek_11_3_private.h"
#include <math.h>
#include "rt_nonfinite.h"
#include "rtwtypes.h"

/* Block signals and states (default storage) */
DW_ornek_11_3_T ornek_11_3_DW;

/* Real-time model */
static RT_MODEL_ornek_11_3_T ornek_11_3_M_;
RT_MODEL_ornek_11_3_T *const ornek_11_3_M = &ornek_11_3_M_;
...
static void rate_scheduler(void)
{
   ...
   */
  (ornek_11_3_M->Timing.TaskCounters.TID[1])++;
  if ((ornek_11_3_M->Timing.TaskCounters.TID[1]) > 999) {/* Sample time: [1.0s, 0.0s] */
    ornek_11_3_M->Timing.TaskCounters.TID[1] = 0;
  }
}

/* Model step function */
void ornek_11_3_step(void)
{
   ...
   */
  if (ornek_11_3_ConstB.MultiportSwitch[0] > 0.0) {
    /* RelationalOperator: '<S6>/Relational Operator1' incorporates:
     *  UnitDelay: '<S4>/Unit Delay'
     */
    ornek_11_3_DW.bitsForTID0.RelationalOperator1 = ((int16_T)rtb_DigitalInput1 > (int16_T)
      ornek_11_3_DW.bitsForTID0.UnitDelay_DSTATE);
  }
   ...
   */
  if (ornek_11_3_ConstB.MultiportSwitch[1] > 0.0) {
    /* RelationalOperator: '<S5>/Relational Operator1' incorporates:
     *  UnitDelay: '<S4>/Unit Delay'
     */
    ornek_11_3_DW.bitsForTID0.RelationalOperator1_m = ((int16_T)ornek_11_3_DW.bitsForTID0.UnitDelay_DSTATE >
   ...
   */
  if (ornek_11_3_DW.bitsForTID0.RelationalOperator1 || ornek_11_3_DW.bitsForTID0.RelationalOperator1_m) {
    rtb_Switch = ornek_11_3_ConstP.Constant1_Value[rtb_DigitalInput];
  } else {
    rtb_Switch = ornek_11_3_DW.Memory_PreviousInput;
  }
   ...
   *  Memory: '<Root>/Memory'
   */
  tmp = floor(ornek_11_3_DW.Memory_PreviousInput);
  ...
  ornek_11_3_DW.RateTransition1_Buffer0 = rtb_DataTypeConversion;
  if (ornek_11_3_M->Timing.TaskCounters.TID[1] == 0) {
  ...
  ornek_11_3_DW.bitsForTID0.UnitDelay_DSTATE = rtb_DigitalInput1;

  /* Update for Memory: '<Root>/Memory' */
  ornek_11_3_DW.Memory_PreviousInput = rtb_Switch;
  rate_scheduler();
}

/* Model initialize function */
void ornek_11_3_initialize(void)
{
  /* Registration code */
...
void ornek_11_3_terminate(void)
{
...
void MCHP_IdleTask(void)
{
  ...
  {
    /* RateTransition: '<Root>/Rate Transition1' */
    ornek_11_3_DW.RateTransition1 = ornek_11_3_DW.RateTransition1_Buffer0;
