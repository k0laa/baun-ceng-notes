...
DW_ornek_6_8_T ornek_6_8_DW;

/* Real-time model */
static RT_MODEL_ornek_6_8_T ornek_6_8_M_;
RT_MODEL_ornek_6_8_T *const ornek_6_8_M = &ornek_6_8_M_;

/* Model step function for TID0 */
void ornek_6_8_step0(void)             /* Sample time: [0.1s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID1 */
void ornek_6_8_step1(void)             /* Sample time: [0.5s, 0.0s] */
{
   ...
   */
  ornek_6_8_DW.UnitDelay_DSTATE = 1.0 - ornek_6_8_DW.UnitDelay_DSTATE;
   ...
   */
  if (PORTCbits.RC0) {
    rtb_Switch = (ornek_6_8_DW.UnitDelay_DSTATE != 0.0);
  } else {
    rtb_Switch = false;
  }
  ...
  LATBbits.LATB0 = rtb_Switch;
}

/* Model initialize function */
void ornek_6_8_initialize(void)
{
  /* Registration code */

  /* Set task counter limit used by the static main program */
  (ornek_6_8_M)->Timing.TaskCounters.cLimit[0] = 1;
  (ornek_6_8_M)->Timing.TaskCounters.cLimit[1] = 5;
...
{
  {
    ...
    struct {
      uint_T Task1;                    /* 0.5s periodic task. Max value is 5 */
    ...
    if (taskCounter.Task1 == 0) {      /* task dropped on overload */
      taskCounter.Task1 = (uint16_T) 5;/* 0.5s periodic task. Max value is 5 */
