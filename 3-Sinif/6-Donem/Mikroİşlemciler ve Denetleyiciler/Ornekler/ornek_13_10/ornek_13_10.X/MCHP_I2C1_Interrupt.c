...
void __attribute__((__interrupt__,__shadow__,__no_auto_psv__)) _MI2C1Interrupt(void) /* MI2C1 ISR */
{
  ...
  switch (MCHP_I2C1_State)
  {
   ...
   case 5:
    I2C1TRN = 0x70;                    /* Write I2C data */
    MCHP_I2C1_State++;
    break;

   case 6:
    I2C1TRN = 0x01;                    /* Write I2C data */
    MCHP_I2C1_State++;
    break;

   case 7:
    I2C1TRN = I2C1_Buff8[0];           /* Write I2C data */
    MCHP_I2C1_State++;
    break;
   ...
   case 10:
    I2C1TRN = 0x02;                    /* Write I2C data */
    MCHP_I2C1_State++;
    break;

   case 11:
    I2C1TRN = I2C1_Buff8[1];           /* Write I2C data */
    MCHP_I2C1_State++;
    break;
