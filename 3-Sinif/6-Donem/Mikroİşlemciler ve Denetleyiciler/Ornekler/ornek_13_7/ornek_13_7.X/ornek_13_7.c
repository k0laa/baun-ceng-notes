...
/* Model step function */
void ornek_13_7_step(void)
{
  /* S-Function (MCHP_ADC): '<Root>/ADC' */
  /* MCHP_ADC Block for ADC 1: <Root>/ADC/Output */
  ornek_13_7_DW.ADC = ADC1BuffChannelA[0];

  /* Gain: '<Root>/Gain1' incorporates:
   *  Gain: '<Root>/Gain'
   */
  ornek_13_7_DW.Gain1 = (uint16_T)mul_u32_loSR(39999UL, (uint32_T)ornek_13_7_DW.ADC << 15, 25UL);

  /* S-Function (MCHP_PWM): '<Root>/PWM' */
  /* PWM Output Function !! */

  /* Update for S-Function (MCHP_PWM): '<Root>/PWM' */
  P1DC1 = ornek_13_7_DW.Gain1;         /* Period for Channel 1 */
}

/* Model initialize function */
void ornek_13_7_initialize(void)
{
...
void ornek_13_7_terminate(void)
{
