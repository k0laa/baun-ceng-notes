...
void ornek_5_5_step(void)
{
   ...
   *  Logic: '<Root>/NOT1'
   */
  rtb_AND = ((!rtb_DigitalInput_o2) && (!rtb_DigitalInput_o3));

  /* Logic: '<Root>/AND1' incorporates:
   *  S-Function (MCHP_Digital_Input): '<Root>/Digital Input'
   */
  rtb_AND1 = (PORTCbits.RC0 && rtb_DigitalInput_o2 && rtb_DigitalInput_o3);

  /* S-Function (MCHP_Digital_Output_Write): '<S1>/Digital Output Write' */
  LATBbits.LATB0 = rtb_AND;
  LATBbits.LATB1 = rtb_AND1;
}

/* Model initialize function */
void ornek_5_5_initialize(void)
{
