...
#include "ornek_6_19.h"
#include <math.h>
#include "rt_nonfinite.h"
#include "rtwtypes.h"

/* Block signals and states (default storage) */
DW_ornek_6_19_T ornek_6_19_DW;

/* Real-time model */
static RT_MODEL_ornek_6_19_T ornek_6_19_M_;
RT_MODEL_ornek_6_19_T *const ornek_6_19_M = &ornek_6_19_M_;

/* Model step function for TID0 */
void ornek_6_19_step0(void)            /* Sample time: [0.01s, 0.0s] */
{
  ...
  (ornek_6_19_M->Timing.RateInteraction.TID0_1)++;
  if ((ornek_6_19_M->Timing.RateInteraction.TID0_1) > 99) {
    ornek_6_19_M->Timing.RateInteraction.TID0_1 = 0;
  }
   ...
   *  UnitDelay: '<S8>/Output'
   */
  rtb_Output_tmp = ornek_6_19_ConstP.Vector_Value_k[ornek_6_19_DW.Output_DSTATE];

  /* DataTypeConversion: '<Root>/Data Type Conversion' incorporates:
   *  Constant: '<Root>/Constant3'
   *  MultiPortSwitch: '<Root>/Index Vector'
   */
  tmp = floor(ornek_6_19_ConstP.Constant3_Value[(int16_T)rtb_Output_tmp - 1]);
  ...
  if (ornek_6_19_M->Timing.RateInteraction.TID0_1 == 1) {
    /* RateTransition generated from: '<Root>/Index Vector1' */
    for (i = 0; i < 5; i++) {
      ornek_6_19_DW.TmpRTBAtIndexVector1Inport2[i] = ornek_6_19_DW.TmpRTBAtIndexVector1Inport2_Buffer0[i];
    }
   ...
   */
  tmp = floor(ornek_6_19_DW.TmpRTBAtIndexVector1Inport2[(int16_T)rtb_Output_tmp - 1]);
  if (rtIsNaN(tmp) || rtIsInf(tmp)) {
    tmp = 0.0;
  } else {
    tmp = fmod(tmp, 65536.0);
   ...
   *  UnitDelay: '<S8>/Output'
   */
  if ((uint8_T)(ornek_6_19_DW.Output_DSTATE + 1U) > 4) {
    ornek_6_19_DW.Output_DSTATE = 0U;
  } else {
    ornek_6_19_DW.Output_DSTATE++;
  }
...
void ornek_6_19_step1(void)            /* Sample time: [1.0s, 0.0s] */
{
   ...
   *  UnitDelay: '<S5>/Output'
   */
  switch ((int16_T)ornek_6_19_ConstP.Vector_Value[ornek_6_19_DW.Output_DSTATE_i]) {
   case 1:
    for (i = 0; i < 5; i++) {
      rtb_MultiportSwitch[i] = ornek_6_19_ConstP.Constant_Value[i];
    }
    break;

   case 2:
    for (i = 0; i < 5; i++) {
      rtb_MultiportSwitch[i] = ornek_6_19_ConstP.Constant1_Value[i];
    }
    break;

   default:
    for (i = 0; i < 5; i++) {
      rtb_MultiportSwitch[i] = ornek_6_19_ConstP.Constant2_Value[i];
    }
    break;
  }
  ...
  /* RateTransition generated from: '<Root>/Index Vector1' */
  for (i = 0; i < 5; i++) {
    ornek_6_19_DW.TmpRTBAtIndexVector1Inport2_Buffer0[i] = rtb_MultiportSwitch[i];
  }
   ...
   *  UnitDelay: '<S5>/Output'
   */
  if ((uint8_T)(ornek_6_19_DW.Output_DSTATE_i + 1U) > 2) {
    ornek_6_19_DW.Output_DSTATE_i = 0U;
  } else {
    ornek_6_19_DW.Output_DSTATE_i++;
  }
...
void ornek_6_19_initialize(void)
{
  /* Registration code */
  ...
  (ornek_6_19_M)->Timing.TaskCounters.cLimit[0] = 1;
  (ornek_6_19_M)->Timing.TaskCounters.cLimit[1] = 100;
...
void ornek_6_19_terminate(void)
{
