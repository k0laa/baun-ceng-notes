...
int main()
{
  ...
  TRISB = 0xFFE0;                      /* Port input (1) / output (0) */
  TRISC = 0xFF80;                      /* Port input (1) / output (0) */
