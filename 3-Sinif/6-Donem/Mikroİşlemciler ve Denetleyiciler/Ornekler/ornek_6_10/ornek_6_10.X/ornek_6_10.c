 ...
 * File: ornek_6_10.c
 *
 * Code generated for Simulink model 'ornek_6_10'.
 *
 * Model version                  : 1.22
 * Simulink Coder version         : 23.2 (R2023b) 01-Aug-2023
 * C/C++ source code generated on : Mon Aug 24 21:18:21 2026
 */

#include "ornek_6_10.h"
#include "ornek_6_10_private.h"
#include "rtwtypes.h"

/* Block signals and states (default storage) */
DW_ornek_6_10_T ornek_6_10_DW;
...
/* Model step function */
void ornek_6_10_step(void)
{
  real_T rtb_Memory;
  boolean_T rtb_DigitalInput;

  /* Memory: '<Root>/Memory' */
  rtb_Memory = ornek_6_10_DW.Memory_PreviousInput;
   ...
   */
  ornek_6_10_DW.bitsForTID0.RelationalOperator = (rtb_Memory >= 10.0);

  /* S-Function (sdspcount2): '<Root>/Counter' */
  if (MWDSP_EPH_R_B(ornek_6_10_DW.bitsForTID0.RelationalOperator, &ornek_6_10_DW.Counter_RstEphState) != 0UL)
  {
    ornek_6_10_DW.Counter_Count = 0U;
  }

  if (MWDSP_EPH_R_B(rtb_DigitalInput, &ornek_6_10_DW.Counter_ClkEphState) != 0UL) {
    if (ornek_6_10_DW.Counter_Count < 255) {
      ornek_6_10_DW.Counter_Count++;
    } else {
      ornek_6_10_DW.Counter_Count = 0U;
    }
  }

  rtb_DigitalInput = (ornek_6_10_DW.Counter_Count == 5);
  ...
  if (rtb_DigitalInput) {
     ...
     *  Sum: '<Root>/Sum'
     */
    ornek_6_10_DW.Memory_PreviousInput = rtb_Memory + 0.01;
  } else {
    /* Update for Memory: '<Root>/Memory' incorporates:
     *  Constant: '<Root>/Constant1'
     */
    ornek_6_10_DW.Memory_PreviousInput = 0.0;
  }
...
void ornek_6_10_initialize(void)
{
  ...
  ornek_6_10_DW.Counter_ClkEphState = 5UL;
  ornek_6_10_DW.Counter_RstEphState = 5UL;
}

/* Model terminate function */
void ornek_6_10_terminate(void)
{
