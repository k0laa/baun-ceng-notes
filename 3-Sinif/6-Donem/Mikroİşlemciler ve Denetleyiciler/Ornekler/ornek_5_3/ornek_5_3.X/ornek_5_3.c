...
void ornek_5_3_step(void)
{
  ...
  rtb_DigitalInput_o1 = PORTCbits.RC3; /* Read pin C3 */
  rtb_DigitalInput_o2 = PORTCbits.RC4; /* Read pin C4 */
   ...
   *  Logic: '<Root>/NOT'
   */
  rtb_DigitalInput_o1 = (((!rtb_DigitalInput_o1) && (!rtb_DigitalInput_o2)) || (rtb_DigitalInput_o1 &&
    rtb_DigitalInput_o2));

  /* S-Function (MCHP_Digital_Output_Write): '<S1>/Digital Output Write' */
  LATAbits.LATA9 = rtb_DigitalInput_o1;
}

/* Model initialize function */
void ornek_5_3_initialize(void)
{
