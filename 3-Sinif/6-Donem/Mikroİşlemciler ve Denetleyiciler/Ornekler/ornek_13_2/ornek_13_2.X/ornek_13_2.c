 ...
 * File: ornek_13_2.c
 *
 * Code generated for Simulink model 'ornek_13_2'.
 *
 * Model version                  : 1.29
 * Simulink Coder version         : 23.2 (R2023b) 01-Aug-2023
 * C/C++ source code generated on : Sat Sep  5 14:44:28 2026
 */

#include "ornek_13_2.h"
#include "rtwtypes.h"

/* Block signals and states (default storage) */
DW_ornek_13_2_T ornek_13_2_DW;

/* Real-time model */
static RT_MODEL_ornek_13_2_T ornek_13_2_M_;
RT_MODEL_ornek_13_2_T *const ornek_13_2_M = &ornek_13_2_M_;

/* Model step function for TID0 */
void ornek_13_2_step0(void)            /* Sample time: [0.01s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID1 */
void ornek_13_2_step1(void)            /* Sample time: [0.1s, 0.0s] */
{
   ...
   */
  ornek_13_2_DW.UnitDelay_DSTATE = 1.0 - ornek_13_2_DW.UnitDelay_DSTATE;
   ...
   */
  if ((PORTCbits.RC0 || PORTCbits.RC1) && PORTCbits.RC2) {
    /* DataTypeConversion: '<Root>/Data Type Conversion' incorporates:
     *  UnitDelay: '<S1>/Unit Delay'
     */
    rtb_DataTypeConversion = (ornek_13_2_DW.UnitDelay_DSTATE != 0.0);
  } else {
    /* DataTypeConversion: '<Root>/Data Type Conversion' incorporates:
     *  Constant: '<Root>/Constant'
     */
    rtb_DataTypeConversion = false;
  }
...
void ornek_13_2_initialize(void)
{
  /* Registration code */

  /* Set task counter limit used by the static main program */
  (ornek_13_2_M)->Timing.TaskCounters.cLimit[0] = 1;
  (ornek_13_2_M)->Timing.TaskCounters.cLimit[1] = 10;
...
void ornek_13_2_terminate(void)
{
