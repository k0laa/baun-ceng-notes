...
#include "ornek_6_12.h"
#include <math.h>
#include "rt_nonfinite.h"
#include "rtwtypes.h"

/* Block signals and states (default storage) */
DW_ornek_6_12_T ornek_6_12_DW;

/* Real-time model */
static RT_MODEL_ornek_6_12_T ornek_6_12_M_;
RT_MODEL_ornek_6_12_T *const ornek_6_12_M = &ornek_6_12_M_;

/* Model step function for TID0 */
void ornek_6_12_step0(void)            /* Sample time: [0.1s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID1 */
void ornek_6_12_step1(void)            /* Sample time: [1.0s, 0.0s] */
{
  real_T tmp;
   ...
   *  UnitDelay: '<S3>/Output'
   */
  tmp = floor(ornek_6_12_ConstP.Vector_Value[ornek_6_12_DW.Output_DSTATE]);
   ...
   *  UnitDelay: '<S3>/Output'
   */
  if ((uint8_T)(ornek_6_12_DW.Output_DSTATE + 1U) > 7) {
    ornek_6_12_DW.Output_DSTATE = 0U;
  } else {
    ornek_6_12_DW.Output_DSTATE++;
  }
...
void ornek_6_12_initialize(void)
{
  /* Registration code */
  ...
  (ornek_6_12_M)->Timing.TaskCounters.cLimit[0] = 1;
  (ornek_6_12_M)->Timing.TaskCounters.cLimit[1] = 10;
...
void ornek_6_12_terminate(void)
{
