...
/* Model step function */
void ornek_5_6_step(void)
{
  boolean_T rtb_NAND;

  /* Logic: '<Root>/NAND' incorporates:
   *  S-Function (MCHP_Digital_Input): '<Root>/Digital Input'
   */
  rtb_NAND = ((!PORTCbits.RC0) || (!PORTCbits.RC1) || (!PORTCbits.RC2) || (!PORTCbits.RC3));

  /* S-Function (MCHP_Digital_Output_Write): '<S1>/Digital Output Write' */
  LATBbits.LATB0 = rtb_NAND;
}

/* Model initialize function */
void ornek_5_6_initialize(void)
{
