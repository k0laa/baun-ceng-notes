 ...
 * File: ornek_5_10.c
 *
 * Code generated for Simulink model 'ornek_5_10'.
 *
 * Model version                  : 1.10
 * Simulink Coder version         : 23.2 (R2023b) 01-Aug-2023
 * C/C++ source code generated on : Thu Jul 16 20:42:32 2026
 */

#include "ornek_5_10.h"
#include "rtwtypes.h"

/* Block signals and states (default storage) */
DW_ornek_5_10_T ornek_5_10_DW;
volatile uint_T ContinueTimeStep __attribute__ ((near)) = 0;/* Microchip Global Variable for single rate scheduler */

/* Model step function */
void ornek_5_10_step(void)
{
   ...
   */
  if (ornek_5_10_ConstB.MultiportSwitch[0] > 0.0) {
    /* RelationalOperator: '<S6>/Relational Operator1' incorporates:
     *  UnitDelay: '<S4>/Unit Delay'
     */
    ornek_5_10_DW.bitsForTID0.RelationalOperator1 = ((int16_T)rtb_DigitalInput_o1 > (int16_T)
      ornek_5_10_DW.bitsForTID0.UnitDelay_DSTATE);
  }
   ...
   */
  if (ornek_5_10_ConstB.MultiportSwitch[1] > 0.0) {
    /* RelationalOperator: '<S5>/Relational Operator1' incorporates:
     *  UnitDelay: '<S4>/Unit Delay'
     */
    ornek_5_10_DW.bitsForTID0.RelationalOperator1_g = ((int16_T)ornek_5_10_DW.bitsForTID0.UnitDelay_DSTATE >
      (int16_T)rtb_DigitalInput_o1);
  }
   ...
   *  S-Function (MCHP_Digital_Input): '<Root>/Digital Input'
   */
  rowIdx = (int16_T)((((uint16_T)(PORTCbits.RC2 || (ornek_5_10_DW.bitsForTID0.RelationalOperator1 ||
    ornek_5_10_DW.bitsForTID0.RelationalOperator1_g)) + ((uint16_T)rtb_DigitalInput_o2 << 1)) << 1) +
                     ornek_5_10_DW.bitsForTID0.Memory_PreviousInput);
  rtb_Logic[0U] = ornek_5_10_ConstP.Logic_table[(uint16_T)rowIdx];
  rtb_Logic[1U] = ornek_5_10_ConstP.Logic_table[(uint16_T)rowIdx + 8U];

  /* S-Function (MCHP_Digital_Output_Write): '<S1>/Digital Output Write' */
  LATBbits.LATB0 = rtb_Logic[0];

  /* Update for UnitDelay: '<S4>/Unit Delay' */
  ornek_5_10_DW.bitsForTID0.UnitDelay_DSTATE = rtb_DigitalInput_o1;

  /* Update for Memory: '<S3>/Memory' */
  ornek_5_10_DW.bitsForTID0.Memory_PreviousInput = rtb_Logic[0];
}

/* Model initialize function */
void ornek_5_10_initialize(void)
{
...
void ornek_5_10_terminate(void)
{
