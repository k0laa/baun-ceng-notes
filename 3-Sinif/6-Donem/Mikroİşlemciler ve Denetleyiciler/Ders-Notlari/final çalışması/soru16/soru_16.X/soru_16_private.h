...
#ifndef RTW_HEADER_soru_16_private_h_
#define RTW_HEADER_soru_16_private_h_
#include "rtwtypes.h"
...
extern void PrintCO(unsigned int ppm);

#endif                                 /* RTW_HEADER_soru_16_private_h_ */
