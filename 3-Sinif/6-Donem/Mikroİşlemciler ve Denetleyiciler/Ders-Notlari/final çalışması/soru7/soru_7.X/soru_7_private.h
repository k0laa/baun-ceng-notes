...
#ifndef RTW_HEADER_soru_7_private_h_
#define RTW_HEADER_soru_7_private_h_
#include "rtwtypes.h"
...
extern void PrintVoltage(double v);

#endif                                 /* RTW_HEADER_soru_7_private_h_ */
