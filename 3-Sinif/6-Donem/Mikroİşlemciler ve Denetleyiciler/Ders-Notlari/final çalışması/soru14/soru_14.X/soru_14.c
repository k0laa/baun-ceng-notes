...
#include "soru_14.h"
#include "rtwtypes.h"
#include "soru_14_private.h"
#include <math.h>
#include "rt_nonfinite.h"

/* Block signals and states (default storage) */
DW_soru_14_T soru_14_DW;
 ...
 *    '<S11>/NEGATIVE Edge'
 */
void soru_14_NEGATIVEEdge(real_T rtu_Enable, boolean_T rtu_IN, boolean_T rtu_INprevious, boolean_T *rty_OUT)
{
 ...
 *    '<S11>/POSITIVE Edge'
 */
void soru_14_POSITIVEEdge(real_T rtu_Enable, boolean_T rtu_IN, boolean_T rtu_INprevious, boolean_T *rty_OUT)
{
...
void soru_14_step(void)
{
  ...
  /* Memory: '<Root>/Memory' */
  rtb_Memory = soru_14_DW.Memory_PreviousInput;
   ...
   */
  tmp = floor(soru_14_ConstP.Constant3_Value[(int16_T)soru_14_DW.Memory_PreviousInput]);
  ...
  soru_14_POSITIVEEdge(soru_14_ConstB.MultiportSwitch_n[0], rtb_DigitalInput_o3,
                       soru_14_DW.bitsForTID0.UnitDelay_DSTATE, &soru_14_DW.RelationalOperator1);

  /* End of Outputs for SubSystem: '<S11>/POSITIVE Edge' */

  /* Outputs for Enabled SubSystem: '<S11>/NEGATIVE Edge' */
  soru_14_NEGATIVEEdge(soru_14_ConstB.MultiportSwitch_n[1], rtb_DigitalInput_o3,
                       soru_14_DW.bitsForTID0.UnitDelay_DSTATE, &soru_14_DW.RelationalOperator1_j);

  /* End of Outputs for SubSystem: '<S11>/NEGATIVE Edge' */

  /* Outputs for Enabled SubSystem: '<S5>/POSITIVE Edge' */
  /* UnitDelay: '<S5>/Unit Delay' */
  soru_14_POSITIVEEdge(soru_14_ConstB.MultiportSwitch[0], rtb_DigitalInput_o1,
                       soru_14_DW.bitsForTID0.UnitDelay_DSTATE_o, &soru_14_DW.RelationalOperator1_n);

  /* End of Outputs for SubSystem: '<S5>/POSITIVE Edge' */

  /* Outputs for Enabled SubSystem: '<S5>/NEGATIVE Edge' */
  soru_14_NEGATIVEEdge(soru_14_ConstB.MultiportSwitch[1], rtb_DigitalInput_o1,
                       soru_14_DW.bitsForTID0.UnitDelay_DSTATE_o, &soru_14_DW.RelationalOperator1_o);

  /* End of Outputs for SubSystem: '<S5>/NEGATIVE Edge' */

  /* Outputs for Enabled SubSystem: '<S8>/POSITIVE Edge' */
  /* UnitDelay: '<S8>/Unit Delay' */
  soru_14_POSITIVEEdge(soru_14_ConstB.MultiportSwitch_c[0], rtb_DigitalInput_o2,
                       soru_14_DW.bitsForTID0.UnitDelay_DSTATE_c, &soru_14_DW.RelationalOperator1_f);

  /* End of Outputs for SubSystem: '<S8>/POSITIVE Edge' */

  /* Outputs for Enabled SubSystem: '<S8>/NEGATIVE Edge' */
  soru_14_NEGATIVEEdge(soru_14_ConstB.MultiportSwitch_c[1], rtb_DigitalInput_o2,
                       soru_14_DW.bitsForTID0.UnitDelay_DSTATE_c, &soru_14_DW.RelationalOperator1_jo);
   ...
   *  Switch: '<Root>/Switch4'
   */
  if (soru_14_DW.RelationalOperator1 || soru_14_DW.RelationalOperator1_j) {
    rtb_Memory = 0.0;
     ...
     */
    rtb_Memory = 0.0;
  } else if (soru_14_DW.RelationalOperator1_n || soru_14_DW.RelationalOperator1_o) {
     ...
     */
    rtb_Memory++;
  } else if (soru_14_DW.RelationalOperator1_f || soru_14_DW.RelationalOperator1_jo) {
  ...
  soru_14_DW.Memory_PreviousInput = rtb_Memory;

  /* Update for UnitDelay: '<S11>/Unit Delay' */
  soru_14_DW.bitsForTID0.UnitDelay_DSTATE = rtb_DigitalInput_o3;

  /* Update for UnitDelay: '<S5>/Unit Delay' */
  soru_14_DW.bitsForTID0.UnitDelay_DSTATE_o = rtb_DigitalInput_o1;

  /* Update for UnitDelay: '<S8>/Unit Delay' */
  soru_14_DW.bitsForTID0.UnitDelay_DSTATE_c = rtb_DigitalInput_o2;
}

/* Model initialize function */
void soru_14_initialize(void)
{
  /* Registration code */
