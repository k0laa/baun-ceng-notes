 ...
 * File: soru11.c
 *
 * Code generated for Simulink model 'soru11'.
 *
 * Model version                  : 1.2
 * Simulink Coder version         : 23.2 (R2023b) 01-Aug-2023
 * C/C++ source code generated on : Sat Jun 20 12:58:06 2026
 */

#include "soru11.h"
#include "soru11_private.h"
#include "rtwtypes.h"

/* Block signals and states (default storage) */
DW_soru11_T soru11_DW;
...
/* Model step function */
void soru11_step(void)
{
  real_T rtb_Memory;
  boolean_T rtb_DigitalInput;

  /* Memory: '<Root>/Memory' */
  rtb_Memory = soru11_DW.Memory_PreviousInput;
   ...
   */
  soru11_DW.bitsForTID0.RelationalOperator = (rtb_Memory >= 3.0);

  /* S-Function (sdspcount2): '<Root>/Counter' */
  if (MWDSP_EPH_R_B(soru11_DW.bitsForTID0.RelationalOperator, &soru11_DW.Counter_RstEphState) != 0UL) {
    soru11_DW.Counter_Count = 0U;
  }

  if (MWDSP_EPH_R_B(rtb_DigitalInput, &soru11_DW.Counter_ClkEphState) != 0UL) {
    if (soru11_DW.Counter_Count < 10) {
      soru11_DW.Counter_Count++;
    } else {
      soru11_DW.Counter_Count = 0U;
    }
  }

  rtb_DigitalInput = (soru11_DW.Counter_Count == 5);
  ...
  if (rtb_DigitalInput) {
     ...
     *  Sum: '<Root>/Sum'
     */
    soru11_DW.Memory_PreviousInput = rtb_Memory + 0.1;
  } else {
    /* Update for Memory: '<Root>/Memory' incorporates:
     *  Constant: '<Root>/Constant1'
     */
    soru11_DW.Memory_PreviousInput = 0.0;
  }
...
void soru11_initialize(void)
{
  ...
  soru11_DW.Counter_ClkEphState = 5UL;
  soru11_DW.Counter_RstEphState = 5UL;
}

/* Model terminate function */
void soru11_terminate(void)
{
