 ...
 * File: soru_9.c
 *
 * Code generated for Simulink model 'soru_9'.
 *
 * Model version                  : 1.23
 * Simulink Coder version         : 23.2 (R2023b) 01-Aug-2023
 * C/C++ source code generated on : Sat Jun 20 12:04:11 2026
 */

#include "soru_9.h"
#include "soru_9_private.h"
#include <math.h>
...
DW_soru_9_T soru_9_DW;

/* Real-time model */
static RT_MODEL_soru_9_T soru_9_M_;
RT_MODEL_soru_9_T *const soru_9_M = &soru_9_M_;
...
void soru_9_step0(void)                /* Sample time: [1.0E-5s, 0.0s] */
{
  real_T rtb_Mod;
  real_T rtb_Mod2;
  real_T rtb_Mod3;
   ...
   *  Memory: '<Root>/Memory'
   */
  rtb_Mod = rt_modd_snf(soru_9_DW.Memory_PreviousInput, 1024.0);
  ...
  if (rtIsNaN(rtb_Switch)) {
    /* DataTypeConversion: '<Root>/Data Type Conversion3' */
    soru_9_DW.DataTypeConversion3 = 0U;
  } else {
    /* DataTypeConversion: '<Root>/Data Type Conversion3' */
    soru_9_DW.DataTypeConversion3 = (uint8_T)fmod(rtb_Switch, 256.0);
  }
   ...
   *  Memory: '<Root>/Memory1'
   */
  rtb_Switch = floor(soru_9_DW.Memory1_PreviousInput);
  ...
  soru_9_DW.DataTypeConversion = rtb_Switch < 0.0 ? -(int16_T)(uint16_T)-rtb_Switch : (int16_T)(uint16_T)
    rtb_Switch;
  ...
  if (rtIsNaN(rtb_Switch)) {
    /* DataTypeConversion: '<Root>/Data Type Conversion1' */
    soru_9_DW.DataTypeConversion1 = 0;
  } else {
    /* DataTypeConversion: '<Root>/Data Type Conversion1' */
    soru_9_DW.DataTypeConversion1 = (int16_T)rtb_Switch;
  }
  ...
  if (rtIsNaN(rtb_Switch)) {
    ...
    soru_9_DW.DataTypeConversion2 = 0;
  } else {
    /* DataTypeConversion: '<Root>/Data Type Conversion2' */
    soru_9_DW.DataTypeConversion2 = (int16_T)rtb_Switch;
  }

  /* End of DataTypeConversion: '<Root>/Data Type Conversion2' */
  /* S-Function (MCHP_C_function_Call): '<Root>/C Function Call1' */
  ekrana_yaz(
             soru_9_DW.DataTypeConversion
             , soru_9_DW.DataTypeConversion1
             , soru_9_DW.DataTypeConversion2
             , soru_9_DW.DataTypeConversion3
             );
   ...
   *  Sum: '<Root>/Sum'
   */
  soru_9_DW.Memory_PreviousInput = rtb_Mod + 1.0;

  /* Update for Memory: '<Root>/Memory1' incorporates:
   *  Constant: '<S3>/FixPt Constant'
   *  Sum: '<S3>/FixPt Sum1'
   */
  soru_9_DW.Memory1_PreviousInput = rtb_Mod2 + 1.0;
}

/* Model step function for TID1 */
void soru_9_step1(void)                /* Sample time: [1.0s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model initialize function */
void soru_9_initialize(void)
{
  /* Registration code */
  ...
  (soru_9_M)->Timing.TaskCounters.cLimit[0] = 1;
  (soru_9_M)->Timing.TaskCounters.cLimit[1] = 100000;
  ...
  soru_9_DW.Memory1_PreviousInput = 1.0;
}

/* Model terminate function */
void soru_9_terminate(void)
{
