 ...
 * File: soru_15.c
 *
 * Code generated for Simulink model 'soru_15'.
 *
 * Model version                  : 1.2
 * Simulink Coder version         : 23.2 (R2023b) 01-Aug-2023
 * C/C++ source code generated on : Sat Jun 20 13:35:07 2026
 */
...
void soru_15_step(void)
{
  ...
  /* Memory: '<Root>/Memory' */
  rtb_Memory = soru_15_DW.Memory_PreviousInput;
  ...
  /* Memory: '<Root>/Memory3' */
  rtb_Memory3 = soru_15_DW.bitsForTID0.Memory3_PreviousInput;
   ...
   */
  rtb_Memory3 = (soru_15_DW.bitsForTID0.Memory1_PreviousInput || (rtb_Memory >= 3.0) || ((!rtb_DigitalInput_o1)
    && rtb_Memory3));
   ...
   */
  rtb_LogicalOperator2 = ((soru_15_DW.Memory2_PreviousInput >= 8.0) && (!rtb_Memory3));
  ...
  if (rtb_DigitalInput_o1) {
    rtb_Memory = soru_15_DW.Memory2_PreviousInput + 0.1;
  } else {
    rtb_Memory = 0.0;
  }
  ...
  soru_15_DW.Memory_PreviousInput = rtb_Switch3;

  /* Update for Memory: '<Root>/Memory2' */
  soru_15_DW.Memory2_PreviousInput = rtb_Memory;

  /* Update for Memory: '<Root>/Memory1' */
  soru_15_DW.bitsForTID0.Memory1_PreviousInput = rtb_Memory3;

  /* Update for Memory: '<Root>/Memory3' */
  soru_15_DW.bitsForTID0.Memory3_PreviousInput = rtb_DigitalInput_o1;
}

/* Model initialize function */
void soru_15_initialize(void)
{
